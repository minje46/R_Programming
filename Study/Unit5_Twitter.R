...
# Convert matric to a data frame to use for the prdictive model
...
library(caTools) # to use the sample.split function
...
# V7
# Build CART and logistic regression to predict negative sentiment
# Build a CART model
...
# Accuracy:
(293+21)/(293+7+34+21) #0.88 little better than CART model
